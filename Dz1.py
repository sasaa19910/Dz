...
best_lecturer_1 = Lecturer('Alex', 'Stepanov')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Lui', 'Petrov')
best_lecturer_2.courses_attached += ['Git']

best_lecturer_3 = Lecturer('Katerina', 'Zareva')
...
cool_reviewer_2 = Reviewer('Konstantin', 'Bender')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Git']

student_1 = Student('Maks', 'Sviridov')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Roman', 'Olegov')
...
student_2.rate_hw(best_lecturer_1, 'Python', 7)
student_2.rate_hw(best_lecturer_1, 'Python', 8)
student_2.rate_hw(best_lecturer_1, 'Python', 9)
